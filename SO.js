...
function dibujar_linea()
{
    ...
    if(ciclo.value<10  && t.value<100)
    {
        offset=65;
    }
    else if(ciclo.value>=10 && ciclo.value<=88 && t.value<100)
    {
        offset=32;
    }
    else if(ciclo.value>=88 && ciclo.value<=100 && t.value<100)
    {
        offset=5;
    }
    else if(t.value>=100 && ciclo.value<40 && ciclo.value>10)
    {
        offset=40;
    }
    else if(t.value>=100 && ciclo.value<=10)
    {
        offset=70;
    }
    else
